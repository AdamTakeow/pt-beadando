 ...
 * adatbázis elemeket.
 * Tartalmaz egy {@link hu.bertalanadam.prt.beadando.db.entitas.FoEntitas FoEntitas} osztályt amely egy közös ősként funkcionál
 * a többi entitás számára. Ezt a megkülönböztetést {@link javax.persistence.MappedSuperclass MappedSuperclass} annotáció jelzi.
